<%-- 
    Document   : gov_home
    Created on : Apr 6, 2017, 1:07:54 AM
    Author     : BHAVIK
--%>
...
<html>
    ...
    <body>
        ...
        <div style="padding-top:10px"></div>
            <center> <label id="status" style="font-weight:400;font-size: 20px;color: black;">Your department can spend max. &nbsp; &#x20b9; <%=session.getAttribute("budget") %></label></center><br>
</div> 
    </body>
</html>
